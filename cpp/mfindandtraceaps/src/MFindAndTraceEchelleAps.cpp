...
#include "MFindAndTraceEchelleAps.h"

using namespace std;

int main(int argc, char *argv[])
{
  cout << "MFindAndTraceEchelleAps::main: argc = " << argc << endl;
  if (argc < 19)
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: Not enough parameters specified!" << endl;
    cout << "USAGE: findandtraceechelleaps <char[] FitsFileName_In> <int CentralSize_X_In> <int CentralSize_Y_In> <double SaturationLevel_In> <double SignalThreshold_In> <double ApertureFWHM_In> <int I_NSum_In> <int I_NStep_In> <int NLost_In> <int NTermsGaussFit_In> <int PolyFitOrder_In> <double XLow_In> <double XMin_In> <double XHigh_In> <double XMax_In> <int MinLength_In> <int MaxLength_In> <int ExtendAps_Up> <int ApertureLength_Down> <char[] DataBaseFileName_Out> [FitsFileName_RefScatter_In=<char[] ReferenceScatteredLightImage_In>] [FitsFileName_MinusScatter_Out=<char[] FitsFileName_MinusScatter_Out>] [FitsFileName_CentersMarked_Out=<char[] FitsFileName_CentersMarked_Out>]" << endl;
    ...
    cout << "Parameter 7: int I_NSum_In - Number of CCD rows to average," << endl;
    cout << "Parameter 8: int I_NStep_In - Step size in CCD rows for tracing attempts," << endl;
    cout << "Parameter 9: int NLost_In - number of consecutive times the profile is lost before breaking up the trace," << endl;
    cout << "Parameter 10: int NTermsGaussFit_In (3-6) - 3: fit mean, sigma, center; 4: 3+constant background; 5: 4 plus background slope," << endl;
    cout << "Parameter 11: int PolyFitOrder_In - Polynomial fitting order for the trace functions," << endl;
    cout << "Parameter 12: double XLow_In - IRAF database parameter - object width left of center," << endl;
    cout << "Parameter 13: double XMin_In - IRAF database parameter - background width left of center," << endl;
    cout << "Parameter 14: double XHigh_In - IRAF database parameter - object width right of center," << endl;
    cout << "Parameter 15: double XMax_In - IRAF database parameter - background width right of center," << endl;
    cout << "Parameter 16: int MinLength_In - minimum length of a trace to count as aperture," << endl;
    cout << "Parameter 17: int MaxLength_In - maximum length of a trace before breaking up the trace," << endl;
    cout << "Parameter 18: int ExtendAps_Up - number of pixels to extend a trace upwards," << endl;
    cout << "Parameter 19: int ApertureLength_Down - aperture length downwards after applying ExtendAps_Up," << endl;
    cout << "Parameter 20: char[] DataBaseFileName_Out - name of database file (database/ap...)" << endl;
    cout << "Parameter 21: [FitsFileName_RefScatter_In=(char[] ReferenceScatteredLightImage_In)]" << endl;
    cout << "Parameter 22: [FitsFileName_MinusScatter_Out=(char[] FitsFileName_MinusScatter_Out)]" << endl;
    cout << "Parameter 23: [FitsFileName_Out=(char[] FitsFileName_Out) - Quality control file with all found apertures set to zero]" << endl;
    cout << "Parameter 24: [FitsFileName_CentersMarked_Out=(char[] FitsFileName_CentersMarked_Out) - Quality control file with all traces set to zero]" << endl;
    exit(EXIT_FAILURE);
  }
...
//  char *P_CharArr_ScatterIn = (char*)argv[2];
  ...
  int I_NSum_In = (int)(atoi((char*)argv[7]));
  int I_NStep_In = (int)(atoi((char*)argv[8]));
  int I_NLost_In = (int)(atoi((char*)argv[9]));
  int I_NTermsGaussFit_In = (int)(atoi((char*)argv[10]));
  int I_PolyFitOrder_In = (int)(atoi((char*)argv[11]));
  double D_XLow_In = (double)(atof((char*)argv[12]));
  double D_XMin_In = (double)(atof((char*)argv[13]));
  double D_XHigh_In = (double)(atof((char*)argv[14]));
  double D_XMax_In = (double)(atof((char*)argv[15]));
  int I_MinLength_In = (int)(atoi((char*)argv[16]));
  int I_MaxLength_In = (int)(atoi((char*)argv[17]));
  int I_ExtendAps_Up = (int)(atoi((char*)argv[18]));
  int I_ApertureLength_Down = (int)(atoi((char*)argv[19]));
  char *P_CharArr_DBOut = (char*)argv[20];
//  char *P_CharArr_Out = (char*)argv[16];
  ...
  for (int i = 21; i <= argc; i++){
    CS.Set((char*)argv[i]);
    cout << "MFindAndTraceEchelleAps: Reading Parameter " << CS << endl;

    CS_comp.Set("FitsFileName_RefScatter_In");
    if (CS.GetLength() > CS_comp.GetLength()){
      delete(P_CS);
      P_CS = CS.SubString(0,CS.CharPos('=')-1);
      cout << "MFindAndTraceEchelleAps::main: *P_CS set to " << *P_CS << endl;
      if (P_CS->EqualValue(CS_comp)){
        delete(P_CS);
        P_CS = CS.SubString(CS_comp.GetLength()+1);
        CS_RefScatter_In = P_CS->Get();
        cout << "MFindAndTraceEchelleAps::main: CS_FitsFileName_RefScatter_In set to " << CS_RefScatter_In << endl;
    ...
    if (CS.GetLength() > CS_comp.GetLength()){
      ...
      if (P_CS->EqualValue(CS_comp)){
        ...
        cout << "MFindAndTraceEchelleAps::main: CS_FitsFileName_MinusScatter_Out set to " << CS_FitsFileName_MinusScatter_Out << endl;
      }
    }
    ...
    if (CS.GetLength() > CS_comp.GetLength()){
      ...
      if (P_CS->EqualValue(CS_comp)){
        ...
        cout << "MFindAndTraceEchelleAps::main: CS_FitsFileName_Out set to " << CS_FitsFileName_Out << endl;
      }
    }
    ...
    if (CS.GetLength() > CS_comp.GetLength()){
      ...
      if (P_CS->EqualValue(CS_comp)){
        ...
        cout << "MFindAndTraceEchelleAps::main: CS_FitsFileName_CentersMarked_Out set to " << CS_FitsFileName_CentersMarked_Out << endl;
      }
    }
  }
...
//  CS_FitsFileName_Out.Set(P_CharArr_Out);
  ...
  cout << "MFindAndTraceEchelleAps::main: CS_DatabaseFileName_Out = " << CS_DatabaseFileName_Out << endl;
  int IPos = CS_DatabaseFileName_Out.LastStrPos(CString("/"));
  cout << "MFindAndTraceEchelleAps::main: CS_DatabaseFileName_Out.LastStrPos(CString(/)) = " << IPos << endl;
  CString *P_CS_DB_Path = CS_DatabaseFileName_Out.SubString(0, CS_DatabaseFileName_Out.LastStrPos(CString("/"))-1);
  cout << "MFindAndTraceEchelleAps::main: *P_CS_DB_Path = " << *P_CS_DB_Path << endl;
  if (!CS_DatabaseFileName_Out.MkDir(*P_CS_DB_Path)){
    cout << "MFindAndTraceEchelleAps::main: ERROR: MkDir(" << *P_CS_DB_Path << ") returned FALSE" << endl;
    exit(EXIT_FAILURE);
  }
  delete(P_CS_DB_Path);

  CFits F_Image;
  cout << "MFindAndTraceEchelleAps::main: Starting F_Image.SetFileName(" << CS_FitsFileName_In.Get() << ")" << endl;
  if (!F_Image.SetFileName(CS_FitsFileName_In))
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.SetFileName(" << CS_FitsFileName_In.Get() << ") returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }

  /// Read FitsFile
  cout << "MFindAndTraceEchelleAps::main: Starting F_Image.ReadArray()" << endl;
  if (!F_Image.ReadArray())
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.ReadArray() returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }
  ...
  if (B_Subtract_RefScatter){
    ...
    seconds = time(NULL);
    cout << "MFindAndTraceEchelleAps::main: Starting to fit scattered light: time = " << seconds << endl;
    ...
    if (!P_CF_Scatter->ScaleImageToFitBackground(D_A2_FlatCrop, D_A2_ScatterCrop, D_Fac))
      return false;
    cout << "MFindAndTraceEchelleAps: D_Fac = " << D_Fac << endl;

    cout << "MFindAndTraceEchelleAps: D_A2_Scatter.rows() = " << D_A2_Scatter.rows() << endl;
    cout << "MFindAndTraceEchelleAps: D_A2_Scatter.cols() = " << D_A2_Scatter.cols() << endl;
...
//  D_A2_Temp.resizeAndPreserve(D_A2_Flat.rows(), D_A2_Flat.cols());
    ...
    /// Write ImOut
    cout << "MFindAndTraceEchelleAps: CS_FitsFileName_MinusScatter_Out = <" << CS_FitsFileName_MinusScatter_Out << ">" << endl;
    if (CS_FitsFileName_MinusScatter_Out.GetLength() > 1){
      if (!F_Image.SetFileName(CS_FitsFileName_MinusScatter_Out))
      {
        cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.SetFileName() returned FALSE!" << endl;
        exit(EXIT_FAILURE);
      }
      if (!F_Image.WriteArray())
      {
        cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.WriteArray() returned FALSE!" << endl;
        exit(EXIT_FAILURE);
      }
    }
    cout << "MFindAndTraceEchelleAps: deleting P_CF_Scatter" << endl;
    delete(P_CF_Scatter);
  ...
  cout << "MFindAndTraceEchelleAps: Starting FindAndTraceApertures" << endl;
  if (!F_Image.FindAndTraceApertures(I_NTermsGaussFit_In,
				     ...
				     I_MaxLength_In,
                                     ...
                                     I_NStep_In,
                                     I_NSum_In)){
    cout << "MFindAndTraceEchelleAps: ERROR: F_Image.FindAndTraceApertures(...) returned FALSE = Exiting program" << endl;
    exit(EXIT_FAILURE);
  }
//  F_Image.SetDatabaseFileName(CS_DatabaseFileName_Out);
  ...
  cout << "MFindAndTraceEchelleAps::main: P_D_A1_YHigh = " << *P_D_A1_YHigh << endl;
  cout << "MFindAndTraceEchelleAps::main: D_A1_YLow = " << D_A1_YLow << endl;
//  exit(EXIT_FAILURE);
  F_Image.Set_YLow(D_A1_YLow);
  D_A1_YHigh_New = (*P_D_A1_YHigh);
  D_A1_YLow_New = D_A1_YLow;
  /// Set DatabaseFileName_Out
  cout << "MFindAndTraceEchelleAps::main: Starting F_Image.SetDatabaseFileName(" << CS_DatabaseFileName_Out << ")" << endl;
  if (!F_Image.SetDatabaseFileName(CS_DatabaseFileName_Out))
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.SetDatabaseFileName(" << CS_DatabaseFileName_Out << ") returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }

  /// Write DatabaseFileName_Out
  cout << "MFindAndTraceEchelleAps::main: Starting F_Image.WriteDatabaseEntry()" << endl;
  if (!F_Image.WriteDatabaseEntry())
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.WriteDatabaseEntry() returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }
...
/*  /// CrossCorrelate spectra
  ...
  cout << "MFindAndTraceEchelleAps::main: Starting F_Image.CalcTraceFunctions()" << endl;
  if (!F_Image.CalcTraceFunctions()){
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.CalcTraceFunctions() returned FALSE" << endl;
    exit(EXIT_FAILURE);
  }
  if (!F_Image.GetApertureCenters(D_A2_ApertureCenters)){
    cout << "MFindAndTraceEchelleAps::main: ERROR: GetApertureCenters(D_A2_ApertureCenters) returned FALSE" << endl;
    exit(EXIT_FAILURE);
  }
  cout << "MFindAndTraceEchelleAps::main: D_A2_ApertureCenters = " << D_A2_ApertureCenters << endl;
  CFits F_Image_Aps;
  ...
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image_Aps.SetDatabaseFileName(" << CS_DatabaseFileName_Out << ") returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }
  ...
  {
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image_Aps.ReadDatabaseEntry() returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }
  if (!F_Image_Aps.CalcTraceFunctions()){
    cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image_Aps.CalcTraceFunctions() returned FALSE!" << endl;
    exit(EXIT_FAILURE);
  }
  ...
  if (!F_Image.FindNearestNeighbour(D_A1_Reference,
    ...
    cout << "MFindAndTraceEchelleAps::main: ERROR: FindNearestNeighbour(D_A1_Reference=" << D_A1_Reference << ",...) returned FALSE" << endl;
    exit(EXIT_FAILURE);
  }
//  int I_CenterAperture = I_NearestNeighbourPos;
  cout << "MFindAndTraceEchelleAps::main: I_CenterAperture = " << I_NearestNeighbourPos << endl;
  ...
  for (int i_ap=0; i_ap<F_Image.Get_NApertures()-1; i_ap++){
    ...
    cout << "MFindAndTraceEchelleAps::main: I_Row(low) = " << I_Row << endl;
    ...
    cout << "MFindAndTraceEchelleAps::main: I_XMin = " << I_XMin << ", I_XMax_Temp = " << I_XMax_Temp << endl;
    I_Row = (*P_D_A1_YCenter)(I_NearestNeighbourPos) + (*P_D_A1_YHigh)(I_NearestNeighbourPos);
    cout << "MFindAndTraceEchelleAps::main: I_Row(high) = " << I_Row << endl;
    ...
    cout << "MFindAndTraceEchelleAps::main: I_XMax = " << I_XMax << ", I_XMin_Temp = " << I_XMin_Temp << endl;
    if (I_XMax < I_XMin){
      swap(I_XMax, I_XMin);
    ...
    if (I_XMax < I_XMax_Temp)
      I_XMax = I_XMax_Temp;
    cout << "MFindAndTraceEchelleAps::main: I_XMin = " << I_XMin << ", I_XMax = " << I_XMax << endl;
    ...
    cout << "MFindAndTraceEchelleAps::main: I_YMin = " << I_YMin << ", I_YMax = " << I_YMax << endl;
    ...
    cout << "MFindAndTraceEchelleAps::main: D_A2_Static = " << D_A2_Static << endl;

    if (!F_Image.Remove_Ith_ElementFromArray((*P_I_A1_ApertureNumbers), I_NearestNeighbourPos)){
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.Remove_Ith_ElementFromArray((*P_I_A1_ApertureNumbers)=" << (*(P_I_A1_ApertureNumbers)) << ", I_NearestNeighbourPos=" << I_NearestNeighbourPos << ") returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    if (!F_Image.Remove_Ith_ElementFromArray(*P_D_A1_YCenter, I_NearestNeighbourPos)){
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.Remove_Ith_ElementFromArray(D_A1_YCenter=" << *P_D_A1_YCenter << ", I_NearestNeighbourPos=" << I_NearestNeighbourPos << ") returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    if (!F_Image.Remove_Ith_ElementFromArray(D_A1_YLow, I_NearestNeighbourPos)){
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.Remove_Ith_ElementFromArray(D_A1_YLow=" << D_A1_YLow << ", I_NearestNeighbourPos=" << I_NearestNeighbourPos << ") returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    if (!F_Image.Remove_Ith_ElementFromArray(*P_D_A1_YHigh, I_NearestNeighbourPos)){
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.Remove_Ith_ElementFromArray(D_A1_YHigh=" << *P_D_A1_YHigh << ", I_NearestNeighbourPos=" << I_NearestNeighbourPos << ") returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    if (!F_Image.Remove_Ith_RowFromArray(D_A2_ApertureCenters, I_NearestNeighbourPos)){
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.Remove_Ith_ElementFromArray(D_A2_ApertureCenters=" << D_A2_ApertureCenters << ", I_NearestNeighbourPos=" << I_NearestNeighbourPos << ") returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    ...
    if (!F_Image.FindNearestNeighbour(D_A1_Reference,
                                      ...
                                      D_A1_NearestNeighbour_Out,
                                      I_NearestNeighbourPos)){
      cout << "MFindAndTraceEchelleAps::main: ERROR: FindNearestNeighbour(D_A2_ApertureCenters) returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    cout << "MFindAndTraceEchelleAps::main: I_NearestNeighbourPos = " << I_NearestNeighbourPos << endl;
    cout << "MFindAndTraceEchelleAps::main: D_A1_NearestNeighbour_Out = " << D_A1_NearestNeighbour_Out << endl;
...
//  if (I_YMin < 0)
    ...
    cout << "MFindAndTraceEchelleAps::main: D_A2_Moving = " << D_A2_Moving << endl;
...
//                                100,//I_NSteps_Y,
                                  ...
                                  I_XCor_Y_Out)){
      exit(EXIT_FAILURE);
      cout << "MFindAndTraceEchelleAps::main: ERROR: CrossCorrelate2D(D_A2_Static = " << D_A2_Static << ", D_A2_Moving = " << D_A2_Moving << ") returned FALSE" << endl;
    }
    cout << "MFindAndTraceEchelleAps::main: CrossCorrelate2D returned TRUE: I_XCor_X_Out = " << I_XCor_X_Out << ", I_XCor_Y_Out = " << I_XCor_Y_Out << endl;
    ...
    cout << "MFindAndTraceEchelleAps::main: D_A1_Reference = " << D_A1_Reference << ": Nearest Neighbour = " << D_A2_ApertureCenters(I_NearestNeighbourPos, Range::all()) << endl;
    cout << "MFindAndTraceEchelleAps::main: I_YMin_Moving = " << I_YMin_Moving << ", I_YMax_Moving = " << I_YMax_Moving << endl;
    cout << "MFindAndTraceEchelleAps::main: I_YMin_Static = " << I_YMin_Static << ", I_YMax_Static = " << I_YMax_Static << endl;
    cout << "MFindAndTraceEchelleAps::main: I_DX = " << I_DX << ", I_DY = " << I_DY << endl;
    cout << "MFindAndTraceEchelleAps::main: D_A1_YHigh_New((*(P_I_A1_ApertureNumbers))(I_NearestNeighbourPos)=" << (*(P_I_A1_ApertureNumbers))(I_NearestNeighbourPos) << ") set to " << D_A1_YHigh_New((*(P_I_A1_ApertureNumbers))(I_NearestNeighbourPos)) << endl;
    cout << "MFindAndTraceEchelleAps::main: D_A1_YLow_New((*(P_I_A1_ApertureNumbers))(I_NearestNeighbourPos)=" << (*(P_I_A1_ApertureNumbers))(I_NearestNeighbourPos) << ") set to " << D_A1_YLow_New((*(P_I_A1_ApertureNumbers))(I_NearestNeighbourPos)) << endl;
    ...
    cout << "MFindAndTraceEchelleAps::main: I_Y_Up = " << I_Y_Up << ", I_Y_Down = " << I_Y_Down << endl;

    D_A1_Reference = D_A2_ApertureCenters(I_NearestNeighbourPos, Range::all());
//    if (i_ap == 10){
//      cout << "MFindAndTraceEchelleAps::main: i_ap = 1 -> Returning FALSE" << endl;
...
*/
  seconds = time(NULL);
  cout << "MFindAndTraceEchelleAps::main: Task finished in " << seconds << " seconds" << endl;
  ...
  /// Write ImOut
  cout << "MFindAndTraceEchelleAps::main: CS_FitsFileName_CentersMarked_Out = " << CS_FitsFileName_CentersMarked_Out << endl;
  if (CS_FitsFileName_CentersMarked_Out.GetLength() > 1){
    cout << "MFindAndTraceEchelleAps::main: Starting F_Image.SetFileName(" << CS_FitsFileName_In << ")" << endl;
    if (!F_Image.SetFileName(CS_FitsFileName_In))
    {
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.SetFileName() returned FALSE!" << endl;
      exit(EXIT_FAILURE);
    ...
    cout << "MFindAndTraceEchelleAps::main: Starting F_Image.ReadDatabaseEntry()" << endl;
    if (!F_Image.ReadDatabaseEntry()){
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.ReadDatabaseEntry() returned FALSE" << endl;
      exit(EXIT_FAILURE);
    }
    cout << "MFindAndTraceEchelleAps::main: Starting F_Image.CalcTraceFunctions()" << endl;
    if (!F_Image.CalcTraceFunctions()){
    ...
    cout << "MFindAndTraceEchelleAps::main: Starting F_Image.MarkCenters()" << endl;
    if (!F_Image.MarkCenters())
    {
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.WriteArray() returned FALSE!" << endl;
      exit(EXIT_FAILURE);
    }
    cout << "MFindAndTraceEchelleAps::main: Starting F_Image.SetFileName(" << CS_FitsFileName_CentersMarked_Out << ")" << endl;
    if (!F_Image.SetFileName(CS_FitsFileName_CentersMarked_Out))
    {
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.SetFileName() returned FALSE!" << endl;
      exit(EXIT_FAILURE);
    }
    cout << "MFindAndTraceEchelleAps::main: Starting F_Image.WriteArray()" << endl;
    if (!F_Image.WriteArray())
    {
      cout << "MFindAndTraceEchelleAps::main: ERROR: F_Image.WriteArray() returned FALSE!" << endl;
      exit(EXIT_FAILURE);
  ...
  cout << "MFindAndTraceEchelleAps: deleting P_CS" << endl;
  delete(P_CS);
  cout << "MFindAndTraceEchelleAps: P_CF_Scatter deleted" << endl;
  return EXIT_SUCCESS;
}
