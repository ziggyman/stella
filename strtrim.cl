procedure strtrim(tempstring, i_mode)
...
#                                                                #
# CATEGORY:         general                                      #
# CALLING SEQUENCE: strtrim(tempstring, i_mode)                  #
...
int    i_mode       = 2            {prompt="mode (0..front, 1..end, 2..both)"}
string out
...
begin
  ...
  startfound = 0
  strlenstr = strlen(out)
  if (i_mode == 1 || i_mode == 2){
